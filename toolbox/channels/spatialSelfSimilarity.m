function mind=spatialSelfSimilarity(I,opts,sigma)
...
if (opts.nChnsSS==8)
  r = 1;
elseif (opts.nChnsSS==4)
  r = 0;
else
  error ('ss channels different than 4&8 are not defined');
end
...
for i=1:numel(xs)
    Dp(:,:,i)=imfilter((I-imshift(I,xs(i),ys(i))).^2,filt);
end
